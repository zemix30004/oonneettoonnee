				...
				<div class="col-lg-9 col-md-8 col-sm-8 col-xs-12 main-content-area">
					...
					<div class="banner-shop">
						<a href="#" class="banner-link">
							<figure><img src="{{ asset('assets/images/shonner.jpg')}}" alt=""></figure>
						</a>
					</div>
					...
					<div class="wrap-shop-control">
						...
						<div class="wrap-right">
							...
							<div class="sort-item orderby ">
								<select name="orderby" class="use-chosen" wire:mode="sorting">
							...
							<div class="sort-item product-per-page">
								<select name="post-per-page" class="use-chosen" wire:mode="pagesize" >
					...
					<div class="widget mercado-widget filter-widget">
						...
						<div class="widget-content">
							...
							<div class="widget-banner">
								<figure><img src="{{ asset('assets/images/size-bannedget.jpg')}}" width="270" height="331" alt=""></figure>
							</div>
						</div>
					</div><!-- Size -->
